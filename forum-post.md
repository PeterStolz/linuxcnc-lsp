...
**Subject:** LinuxCNC LSP: smart editing and live error-checking for HAL, INI and G-code (VS Code / any LSP editor)
...
- **Type conflicts**, such as linking a `bit` pin to a `float` signal
